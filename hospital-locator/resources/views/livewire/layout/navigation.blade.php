        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('create_hospital')" :active="request()->routeIs('create_hospital')" wire:navigate>
                        {{ __('Add Hospital') }}
                    </x-nav-link>
