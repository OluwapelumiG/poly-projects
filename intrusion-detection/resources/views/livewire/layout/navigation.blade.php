        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if (Auth()->user()->id == 1)
                        <x-nav-link :href="route('user_enrollment.create')" :active="request()->routeIs('user_enrollment.create')" wire:navigate>
                            {{ __('Create User') }}
                        </x-nav-link>
                    @else
                        ...
                        <x-nav-link :href="route('fees_payment')" :active="request()->routeIs('fees_payment')" wire:navigate>
                            {{ __('Fees Payment') }}
                        </x-nav-link>
                    @endif
