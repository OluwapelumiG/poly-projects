<div>
                ...
                <form wire:submit.prevent="addPerson">
                    <div class="grid grid-cols-2 gap-2">
                        ...
                        {{-- <div class="mb-2 col-span-2">
                            <label for="health_information" class="block text-gray-700">Health Information</label>
                            <textarea id="health_information" wire:model="health_information" class="w-full px-3 py-2 border rounded"></textarea>
                            @error('health_information') <span class="text-red-500">{{ $message }}</span> @enderror
                        </div> --}}
                        <div class="mb-2 col-span-2">
        ...
        <div class="fixed inset-0 bg-gray-500 bg-opacity-75 flex justify-center items-center">
            <div class="bg-white p-8 rounded shadow-lg max-w-2xl w-full">
                ...
                <div>
                    ...
                    <p><strong>Health Information:</strong> <span id="view_health_information"></span></p>
    ...
    <script>
        ...
        document.getElementById('view_health_information').innerText = person.health_information;
